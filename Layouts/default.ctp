                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-messages">
                        <!-- <li>
                            <div class="dropdown-messages-box">
                                <a href="profile.html" class="pull-left">
                                    <img alt="image" class="img-circle" src=<?php echo  $this->webroot.'../theme/Inspinia/img/a7.jpg' ; ?> >
                                </a>
                        ...
                        <li>
                            <div class="dropdown-messages-box">
                                <a href="profile.html" class="pull-left">
                                    <img alt="image" class="img-circle" src=<?php echo $this->webroot.'../theme/Inspinia/img/a4.jpg' ; ?>>
                                </a>
                                <div class="media-body ">
                        ...
                        <li>
                            <div class="dropdown-messages-box">
                                <a href="profile.html" class="pull-left">
                                    <img alt="image" class="img-circle" src=<?php echo  $this->webroot.'../theme/Inspinia/img/profile.jpg' ; ?>>
                                </a>
                                <div class="media-body ">
                                        ...
                                        <div>
                                            <div class="feed-activity-list">
                                                ...
                                                <div class="feed-element">
                                                    <a href="profile.html" class="pull-left">
                                                        <img alt="image" class="img-circle" src=<?php $this->webroot.'../theme/Inspinia/img/profile.jpg' ; ?>>
                                                    </a>
                                                    <div class="media-body ">
                                                ...
                                                <div class="feed-element">
                                                    <a href="profile.html" class="pull-left">
                                                        <img alt="image" class="img-circle" src=<?php $this->webroot.'../theme/Inspinia/img/a2.jpg' ; ?>>
                                                    </a>
                                                    <div class="media-body ">
                                                ...
                                                <div class="feed-element">
                                                    <a href="profile.html" class="pull-left">
                                                        <img alt="image" class="img-circle" src="<?php $this->webroot.'../theme/Inspinia/img/a3.jpg' ; ?>>
                                                    </a>
                                                    <div class="media-body ">
                                                        <small class="pull-right">2h ago</small>
                                                ...
                                                <div class="feed-element">
                                                    <a href="profile.html" class="pull-left">
                                                        <img alt="image" class="img-circle" src=<?php $this->webroot.'../theme/Inspinia/img/a4.jpg' ; ?> >
                                                    </a>
                                                    <div class="media-body ">
                                                        <small class="pull-right text-navy">5h ago</small>
                                                        <strong>Chris Johnatan Overtunk</strong> started following <strong>Monica Smith</strong>. <br>
                                                ...
                                                <div class="feed-element">
                                                    <a href="profile.html" class="pull-left">
                                                        <img alt="image" class="img-circle" src=<?php $this->webroot.'../theme/Inspinia/img/a5.jpg' ; ?> >
                                                    </a>
                                                    <div class="media-body ">
                                                        <small class="pull-right">2h ago</small>
                                                ...
                                                <div class="feed-element">
                                                    <a href="profile.html" class="pull-left">
                                                        <img alt="image" class="img-circle" src=<?php $this->webroot.'../theme/Inspinia/img/a7.jpg' ; ?>>
                                                    </a>
                                                    <div class="media-body ">
                                                        <small class="pull-right">46h ago</small>
                                                        <strong>Mike Loreipsum</strong> started following <strong>Monica Smith</strong>. <br>
                    ...
                    <div id="tab-1" class="tab-pane active">
                        ...
                        <div>
                            ...
                            <div class="sidebar-message">
                                <a href="#">
                                    <div class="pull-left text-center">
                                        <img alt="image" class="img-circle message-avatar" src=<?php $this->webroot.'../theme/Inspinia/img/a1.jpg' ; ?>>
                            ...
                            <div class="sidebar-message">
                                <a href="#">
                                    <div class="pull-left text-center">
                                        <img alt="image" class="img-circle message-avatar" src=<?php $this->webroot.'../theme/Inspinia/img/a2.jpg' ; ?>>
                                    </div>
                                    <div class="media-body">
                            ...
                            <div class="sidebar-message">
                                <a href="#">
                                    <div class="pull-left text-center">
                                        <img alt="image" class="img-circle message-avatar" src=<?php $this->webroot.'../theme/Inspinia/img/a3.jpg' ; ?>>
                            ...
                            <div class="sidebar-message">
                                <a href="#">
                                    <div class="pull-left text-center">
                                        <img alt="image" class="img-circle message-avatar" src=<?php $this->webroot.'../theme/Inspinia/img/a4.jpg' ; ?>>
                                    </div>
                            ...
                            <div class="sidebar-message">
                                <a href="#">
                                    <div class="pull-left text-center">
                                        <img alt="image" class="img-circle message-avatar" src=<?php $this->webroot.'../theme/Inspinia/img/a8.jpg' ; ?>>
                                    </div>
                                    <div class="media-body">
                            ...
                            <div class="sidebar-message">
                                <a href="#">
                                    <div class="pull-left text-center">
                                        <img alt="image" class="img-circle message-avatar" src=<?php $this->webroot.'../theme/Inspinia/img/a7.jpg' ; ?>>
                                    </div>
                                    <div class="media-body">
